...
RUN DEBIAN_FRONTEND='noninteractive' apt-get install -y php5 php5-cli php5-mysql
php5-fpm php5-apcu php5-curl php5-imagick php5-mongo php5-xdebug php5-mcrypt
php5-gd  && \
